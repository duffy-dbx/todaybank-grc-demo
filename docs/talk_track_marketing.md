# Axos GRC Demo — Marketing Team Talk Track (4 min)
...
1. Genie space "Axos GRC Operations Hub"
2. `axos_grc_demo.silver.complaints_classified` in Catalog Explorer (for the data peek)
