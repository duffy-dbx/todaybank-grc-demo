-- ===================================================================
-- Axos GRC Operations Hub — Dashboard Queries
...
FROM axos_grc_demo.silver.customers
...
FROM axos_grc_demo.silver.complaints_classified
...
SELECT
  ...
  source_of_funds,
  pep_status
FROM axos_grc_demo.gold.kyc_pep_matches
...
FROM axos_grc_demo.gold.aml_risk_scores
